...
const RESPONSE_SCHEMA = `{
    "feasibility": {
        ...
        "content": <Análise objetiva sobre se meta é atingível no prazo com o valor disponível. Mencione os números relevantes.>
    },
    "diagnosis":{
...
export function buildAIPrompt(simulation: SimulationRecord) {
  ...
  return `Você é um educador financeiro especializado em finanças pessoais.
        ...
        Retorne APENAS um JSSON válido, sem texto adicional, sem blocos de código, neste formato exato:
        ...
        - Para o campo "feasibility.status", use os seguintes critérios:
            - "viable": saldo após reserva para meta é maaior ou igual a 0
